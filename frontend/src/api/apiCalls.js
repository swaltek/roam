...
apiCalls.updateListingById = async (listingId, listingData) => {
  ...
  return await apiHelpers.tryCatchFetch(
    () => axios.patch(`${BASE_URL}/listings/${listingId}/`, listingData, apiHelpers.getCsrfConfig()))
}

apiCalls.deleteListingById = async (listingId) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.delete(`${BASE_URL}/listings/${listingId}/`, apiHelpers.getCsrfConfig()))
}
...
apiCalls.updateAmenityById = async (amenityId, amenityData) => {
  console.log("csrf: ", apiHelpers.getCsrfConfig())
  return await apiHelpers.tryCatchFetch(
    () => axios.patch(`${BASE_URL}/amenities/${amenityId}/`, amenityData, apiHelpers.getCsrfConfig()))
}

apiCalls.deleteAmenityById = async (amenityId) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.delete(`${BASE_URL}/amenities/${amenityId}/`, apiHelpers.getCsrfConfig()))
}
...
apiCalls.updateReviewById = async (reviewId, reviewData) => {
  console.log("csrf: ", apiHelpers.getCsrfConfig())
  return await apiHelpers.tryCatchFetch(
    () => axios.patch(`${BASE_URL}/reviews/${reviewId}/`, reviewData, apiHelpers.getCsrfConfig()))
}
...
apiCalls.createReservation = async (reservationData) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.post(`${BASE_URL}/reservations/`, reservationData, apiHelpers.getCsrfConfig()))
}

apiCalls.getReservationById = async (reservationId) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.get(`${BASE_URL}/reservations/${reservationId}/`, apiHelpers.getCsrfConfig()))
}

apiCalls.updateReservationById = async (reservationId, reservationData) => {
  console.log("csrf: ", apiHelpers.getCsrfConfig())
  return await apiHelpers.tryCatchFetch(
    () => axios.patch(`${BASE_URL}/reservations/${reservationId}/`, reservationData, apiHelpers.getCsrfConfig()))
}

apiCalls.deleteReservationById = async (reservationId) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.delete(`${BASE_URL}/reservations/${reservationId}/`, apiHelpers.getCsrfConfig()))
}
...
apiCalls.createAddress = async (addressData) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.post(`${BASE_URL}/addresses/`, addressData, apiHelpers.getCsrfConfig()))
}
...
apiCalls.updateAddressById = async (addressId, addressData) => {
  console.log("csrf: ", apiHelpers.getCsrfConfig())
  return await apiHelpers.tryCatchFetch(
    () => axios.patch(`${BASE_URL}/addresses/${addressId}/`, addressData, apiHelpers.getCsrfConfig()))
}

apiCalls.deleteAddressById = async (addressId) => {
  return await apiHelpers.tryCatchFetch(
    () => axios.delete(`${BASE_URL}/addresses/${addressId}/`, apiHelpers.getCsrfConfig()))
}
