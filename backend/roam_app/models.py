...
class Listing(models.Model):
    ...
    location_lng = models.DecimalField(null=True, max_digits=8, decimal_places=5,validators=[MinValueValidator(-180, message=LNG_VALIDATOR_MSG), MaxValueValidator(180, message=LNG_VALIDATOR_MSG)])
    location_lat = models.DecimalField(null=True, max_digits=7, decimal_places=5,validators=[MinValueValidator(-90, message=LAT_VALIDATOR_MSG), MaxValueValidator(90, message=LAT_VALIDATOR_MSG)])
